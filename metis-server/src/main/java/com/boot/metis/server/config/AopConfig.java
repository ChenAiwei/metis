...
import com.boot.metis.server.annotation.Log;
...
public class AopConfig {
	...
	@Around("pointcut() && (@within(com.boot.metis.server.annotation.Log) || @annotation(com.boot.metis.server.annotation.Log))")
	...
	@Before("@within(com.boot.metis.server.annotation.Log) || @annotation(com.boot.metis.server.annotation.Log)")
	public void doBefore(JoinPoint joinPoint){
	}

	@After("@within(com.boot.metis.server.annotation.Log) || @annotation(com.boot.metis.server.annotation.Log)")
	public void doAfter() {}
}
