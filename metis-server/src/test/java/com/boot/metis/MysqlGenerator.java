...
public class MysqlGenerator {
	...
	public static void Generator(String[] tableName) {
		...
		System.out.println("生成的根目录为："+projectPath);
		...
		dsc.setDbType(DbType.MYSQL)
				.setUrl("jdbc:mysql://1.15.108.136:3306/metis?characterEncoding=utf-8&useSSL=false&useUnicode=true&serverTimezone=GMT%2B8")
		...
		pc.setParent("com.boot.metis")//配置父包路径
		...
		focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
			...
			public String outputFile(TableInfo tableInfo) {
				// 自定义输入文件名称
				return projectPath + "/mybatisplus/src/main/resources/mybatis/"
